...
import com.ascafi.projetomoviesmvvmkt.R
import com.ascafi.projetomoviesmvvmkt.data.api.TheMovieDBClient
...
import com.ascafi.projetomoviesmvvmkt.ui.one_movie_detail.SingleMovieViewModel
...
class MainActivity : AppCompatActivity() {
    ...
    lateinit var movieDetailsRepository: MoviePagedListRepository
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        movieDetailsRepository = MoviePagedListRepository(apiService)
    ...
    private fun getViewModel(): MainActivityViewModel {
        return ViewModelProviders.of(this, object : ViewModelProvider.Factory {
            override fun <T : ViewModel?> create(modelClass: Class<T>): T {
                ...
                return MainActivityViewModel(movieDetailsRepository) as T
            }
